...
class Draft {
    ...
    async nextDraft() {
        if (this.draftNumber < 5) {
            ...
            const endMessageTwo = 'One of the captains should create a lobby and add all players. When the match is finished, please DM me with `!match report <win | loss>` to report score.';
